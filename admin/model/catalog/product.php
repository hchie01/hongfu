...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		if (isset($data['pid'])) {
			// foreach ($data['pid'] as $category_id) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_to_category SET product_id = '" . (int)$product_id . "', category_id = '" . (int)$data['pid'] . "'");
			// }
		}
...
// echo '</pre>';die;
	...
	public function copyProduct($product_id) {
		...
		if ($query->num_rows) {
			...
			$data['pid'] = $this->getProductCategories($product_id);
