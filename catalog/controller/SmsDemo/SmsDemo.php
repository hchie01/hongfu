...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI7X7pA9tXqTL0"; // AccessKeyId

        $accessKeySecret = "OHfJaaGB85xf59GLGIVCV11EY56gN2"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($tel,$cap) {
        ...
        $request->setSignName("中隆和益有限公司");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_149096754");
...
$response = SmsDemo::sendSms(18600326531,666888);
