...
// echo '<pre>';
// print_r($this->model_account_customer->getCustomerByTelephone($this->request->post['email']));
...
// echo '</pre>';die;
	...
	protected function validate() {
        ...
        // if(isset($this->requst->post['password']) && !empty($this->request->post['password'])){
        // 	if(MD5($this->request->post['password'])!=$customer_info['password']){
        // 		$this->error['warning'] = '123';
        // 	}
        // }
...
// echo '</pre>';die;
	...
	public function token() {
		...
		if ($customer_info && $customer_info['token'] && $customer_info['token'] == $token && $this->customer->login($customer_info['customer_id'], '', true)) {
			...
			// $this->model_account_customer->editToken($customer_info['shopname'], '');
