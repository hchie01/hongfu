...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		if ($category_info) {
			...
			$data['column_left'] = $this->load->controller('common/col_left');
			$data['column_right'] = $this->load->controller('common/col_right');
			$data['content_top'] = $this->load->controller('common/cont_top');
			$data['content_bottom'] = $this->load->controller('common/con_bottom');
			...
			$this->document->setTitle($this->language->get('text_all'));
			...
			// $data['column_right'] = $this->load->controller('common/col_right');
			// $data['content_top'] = $this->load->controller('common/cont_top');
			$data['content_bottom'] = $this->load->controller('common/cont_bottom');
			$data['footer'] = $this->load->controller('common/footer');
			$data['header'] = $this->load->controller('common/header');
